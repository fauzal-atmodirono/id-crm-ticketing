...
OUT = os.path.join(BASE, "PROTON - Technical Proposal - Self-Managed CRM on Google Cloud (v4).pptx")
...
textbox(s, Inches(0.7), Inches(4.33), Inches(8.6), Inches(0.4),
        [[("August 2026   ·   Version 4.0   ·   Demonstrated live 28 July 2026   ·   Confidential", 10, False, LIGHT)]])
...
divider(3, "Delivery & Commercials", "Timeline · Scope · Deliverables · Engagement")

# ---------- 21. PROJECT TIMELINE ----------
s = slide()
page_header(s, "Section 3", "Project Timeline — 8 Weeks (2 Months), Accelerated")
...
s = slide()
page_header(s, "Section 3", "How We Get to 8 Weeks")
...
textbox(s, Inches(0.55), Inches(4.92), Inches(8.9), Inches(0.5),
        [[("Assumptions:  ", 9, True, POPPY),
          ("PROTON provides GCP billing/org access, DMS/TSP API + data contracts, email domain, Zendesk export, UAT participants, and a telephony/CTI decision.",
           9, False, DARK)],
         [("Delivery model:  ", 9, True, POPPY),
          ("accelerator-led — 120 mandays over 36 working days, delivered inside a 2-month calendar.",
           9, False, DARK)]], line_spacing=1.1, space_after=3)
footer(s, npg())
...
# ---------- 25. EFFORT & MANDAYS ----------
s = slide()
page_header(s, "Section 3", "Effort Estimate — Mandays")
...
s = slide()
page_header(s, "Section 3", "GCP Pricing & Specification")
...
s = slide()
page_header(s, "Section 3", "Google Program Funding — Exploratory")
...
s = slide()
page_header(s, "Section 3", "Engagement & Next Steps")
