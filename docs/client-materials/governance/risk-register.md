...
Patches **0052 through 0060** — nine of them — have never been applied to a real
...
| `0060` | P10 task 4 taxonomy admin page | Applied to a synthetic tree; the backend behind it is mounted and tested. Blocked-work register §3m |
...
| R7 | 9 fork patches never applied to real upstream | H | M | Cloud Build, amd64, off-VM |
