...
# Administrator curriculum — hands-on exercises
...
**32 exercises.** Every step is the handbook's own documented procedure for that feature, so an exercise cannot drift from the guide the cohort keeps.
...
**24 are procedures** the trainee carries out themselves, taken from a handbook section's *How to use it* steps. **8 are role-plays** drawn from the end-to-end scenarios, where the facilitator plays the customer — those narratives are told from both sides, so they are not a checklist one trainee can work through alone.

## AD-01 — Conversation inbox & views
...
## AD-07 — Resolving, snoozing & transcripts
...
**Module:** 04 Knowledge · **Source:** `04-knowledge.md` → `## FAQs`

**Where:** In the left-hand navigation, open **Knowledge** and select **FAQs**.
...
**Expect this limitation:** Entries created through the bulk upload are always saved as active — if you need an imported entry to start out inactive, edit it afterwards and uncheck **Active**.

## AD-10 — Documents

**Module:** 04 Knowledge · **Source:** `04-knowledge.md` → `## Documents`

**Where:** In the left-hand navigation, open **Knowledge** and select **Documents** for the read-only corpus listing, or **Uploads** to add new material.
...
**Done when:** all 3 steps have been carried out on the sandbox tenant without help.

## AD-11 — Playground

**Module:** 04 Knowledge · **Source:** `04-knowledge.md` → `## Playground`

**Where:** In the left-hand navigation, open **Knowledge** and select **Playground**.
...
## AD-13 — Case categorisation (five fields)
...
**Module:** 09 Administration (Settings) · **Source:** `09-administration.md` → `## Agents`

**Where:** Open **Settings** (the gear icon) and select **Agents**.
...
## AD-19 — Inboxes (incl. inactivity timing)

**Module:** 09 Administration (Settings) · **Source:** `09-administration.md` → `## Inboxes (incl. inactivity timing)`

**Where:** Open **Settings** (the gear icon) and select **Inboxes**, then choose the inbox you want to configure.
...
## AD-20 — Custom Attributes

**Module:** 09 Administration (Settings) · **Source:** `09-administration.md` → `## Custom Attributes`

**Where:** Open **Settings** (the gear icon) and select **Custom Attributes**.
...
**Module:** 09 Administration (Settings) · **Source:** `09-administration.md` → `## Audit Log`

**Where:** In the main left-hand navigation, select **Audit Log** (visible only if your role has been granted the "View the audit log" permission — see **Roles & Permissions** below).
...
## AD-23 — Roles & Permissions

**Module:** 09 Administration (Settings) · **Source:** `09-administration.md` → `## Roles & Permissions`

**Where:** In the main left-hand navigation, select **Roles & Permissions** (visible only if your role has been granted the "Manage roles and permission assignments" permission).
...
## AD-24 — Escalation Routing

**Module:** 09 Administration (Settings) · **Source:** `09-administration.md` → `## Escalation Routing`

**Where:** In the main left-hand navigation, select **Escalation Routing** (visible only if your role has been granted the "Manage PIC/dealer escalation routing" permission).
...
## AD-25 — Scenario 1: WhatsApp inquiry to resolution  *(role-play)*
...
## AD-26 — Scenario 2: Complaint escalation, the dealer's reply, and the turnaround report  *(role-play)*
...
## AD-27 — Scenario 4: FAQ batch import to live bot answer  *(role-play)*

**Module:** 11 End-to-End Scenarios · **Source:** `11-scenarios.md` → `## Scenario 4: FAQ batch import to live bot answer`
...
## AD-28 — Scenario 5: Weekly reporting routine  *(role-play)*
...
## AD-29 — Scenario 6: New agent onboarding  *(role-play)*

**Module:** 11 End-to-End Scenarios · **Source:** `11-scenarios.md` → `## Scenario 6: New agent onboarding`
...
## AD-30 — Scenario 8: Maintaining a dealer group  *(role-play)*

**Module:** 11 End-to-End Scenarios · **Source:** `11-scenarios.md` → `## Scenario 8: Maintaining a dealer group`
...
## AD-31 — Scenario 10: Adjusting SLA thresholds ahead of a launch event  *(role-play)*
...
## AD-32 — Scenario 15: Categorising a case through all five taxonomy dropdowns  *(role-play)*
